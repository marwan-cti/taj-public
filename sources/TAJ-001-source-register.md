# Source Register — TAJ Note 001

This register supports: **TAJ Note 001 — Malwares intégrant des LLM à l’exécution**.
...
- CERT-UA — [Cyberattack using LAMEHUG malware](https://cert.gov.ua/article/6284730)
...
CERT-UA is treated as the primary institutional source for LAMEHUG. Google Cloud, MITRE ATT&CK and Cato Networks are used as corroborating technical and framework sources.
